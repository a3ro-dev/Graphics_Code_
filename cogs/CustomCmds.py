...
"""
    ...
    async def botinfo(self, ctx): 
             ...
             embed.add_field(name='<:fancyarr:1064443589825933343> Name', value=f'```{self.bot.user.name}```', inline=False) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Created on', value=f'```{(self.bot.user.created_at.strftime(f"%d/%m/%y"))}```', inline=True) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Library', value=f'```discord.py v2```', inline=True) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Ping', value=f'```{round(self.bot.latency*1000)}ms```', inline=True) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Api version', value=f"```{discord.__version__}```", inline=True) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Bot version', value=f'```v5.1```', inline=True) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Developers', value=f'```HELLTRONIX#5209, Poison Tribbiani#0057, Lxghtning~#0388```', inline=False) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Servers', value=f'```{len(self.bot.guilds)}```', inline=True) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Members', value=f'```{len(self.bot.users)}```', inline=True) 
             embed.add_field(name='<:fancyarr:1064443589825933343> Commands', value=f'```{len(self.bot.commands)}```', inline=True) 
             embed.color(cfg.CLR)
             embed.set_footer(text = f'{self.bot.user.name} | {self.bot.user.id}', icon_url=self.bot.user.avatar.url) 
             embed.timestamp = discord.utils.utcnow() 
             await ctx.send(embed = embed)    
...
⪦━━━━━━━━━━━━━━━━━━━━━━━⪧
               ...
               <:red_star:1150362128797155398>General Instructions**<:red_star:1150362128797155398>
...
⪦━━━━━━━━━━━━━━━━━━━━━━━⪧
               ...
               <:red_star:1150362128797155398>**Ticket Instructions**<:red_star:1150362128797155398>
...
⪦━━━━━━━━━━━━━━━━━━━━━━━⪧
               ...
               <:red_star:1150362128797155398>**Things to be Noted**<:red_star:1150362128797155398>
